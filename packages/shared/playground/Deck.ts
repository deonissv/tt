import { SubMesh, MultiMaterial } from '@babylonjs/core';
import { ActorBase } from './ActorBase';

import { DeckState } from '@shared/dto/pg/actorState';
...
export class Deck extends ActorBase {
  static async fromState(state: DeckState): Promise<Deck | null> {
    ...
    return new Deck(state.guid, state.name, model, undefined, state.transformation, CARD_MASS);
  }
}
